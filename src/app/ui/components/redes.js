...
function Redes() {
  return (
    <div className={ `${styles.redes} contenedor `}>
      <p>Seguinos en nuestras Redes Sociales!!</p>

      <div className={styles.red}>

    <Link href="https://instagram.com/deporvida.gym?igshid=YTQwZjQ0NmI0OA==" target="_blank">
    <button className={styles.BtnI}>
            <span className={styles.svgContainerI}>
            ...
            <span className={styles.BGI}></span>      
    </button>
    </Link>

        <Link  href="https://www.facebook.com/deporvida.gym" target="_blank">
